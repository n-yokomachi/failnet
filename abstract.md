...
- Amazon Bedrock AgentCore
  - AI Agentのインフラとして使用。Strands Agentによるエージェントアプリケーションをホストする。
  - 開発中期から使用して、カテゴリ分類、センシティブ情報検出に特化したエージェントの構築に使用する
  - https://qiita.com/Takenoko4594/items/5284ee591d149e8ec7a1
- Strands Agent
  - AWS提供のエージェントフレームワーク。
  - Amazon Bedrock AgentCoreを使用したAI Agentの構築を行う際に、そのソフトウェアフレームワークとして使用
